...
[DesignerGenerated]
public class frmPurchaseInvoiceList : Form
{
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(GCUv2.frmPurchaseInvoiceList));
		...
		this.lblTitle.Text = "Faktur Pembelian terbaru:";
		...
		base.ClientSize = new System.Drawing.Size(536, 382);
		base.Controls.Add(this.lblTitle);
		base.Controls.Add(this.dgvList);
		base.Controls.Add(this.ToolStrip1);
		base.KeyPreview = true;
		base.MaximizeBox = false;
		base.Name = "frmPurchaseInvoiceList";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Faktur Pembelian";
	...
	private void frmPurchaseInvoiceList_KeyDown(object sender, KeyEventArgs e)
	{
	...
	{
		base.KeyDown += frmPurchaseInvoiceList_KeyDown;
		base.Load += frmPurchaseInvoiceList_Load;
		InitializeComponent();
		...
		while (true)
		{
			try
			{
				...
				default:
				{
					...
					{
						lblTitle.Text = "Faktur Pembelian terbaru (Hanya Faktur yang belum memiliki harga)";
					}
					dataTable = cPurchaseInvoice.Search(2, DateAndTime.Now, DateAndTime.Now, 0, 0, "", 99, 0, Module1.pubGroupId, 0, 99, 99, Module1.pubViewReportPurchaseInvoicePrice);
					FormatGrid();
					IEnumerator enumerator = dataTable.Rows.GetEnumerator();
					while (enumerator.MoveNext())
					{
						DataRow dataRow = (DataRow)enumerator.Current;
						dgvList.Rows.Add(dataRow["invId"], dataRow["invDate"], dataRow["supName"], dataRow["invNumber"], Module1.formatCustomDecimal(Conversions.ToString(dataRow["invTotal"]), 2));
					}
					if (enumerator is IDisposable)
					{
						(enumerator as IDisposable).Dispose();
					}
					lblTitle.Text = "Faktur Pembelian terbaru (" + Conversions.ToString(DateAndTime.Now) + ")";
					goto end_IL_0001;
				}
				case 349:
					num = -1;
					...
					{
					case 2:
						Module1.SaveError(Information.Err(), "frmPurchaseInvoiceList", "GetRecent", "");
						goto end_IL_0001;
					}
					break;
				}
