...
[DesignerGenerated]
public class frmReportCustomerPayment : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.cboCollector.Location = new System.Drawing.Point(101, 225);
		...
		this.cboPaymentCode.Location = new System.Drawing.Point(100, 198);
		...
		this.btnReset.Location = new System.Drawing.Point(156, 252);
		...
		this.btnSearch.Location = new System.Drawing.Point(102, 252);
		...
		((System.Windows.Forms.Control)(object)this.ShapeContainer1).Size = new System.Drawing.Size(961, 523);
		((System.Windows.Forms.Control)(object)this.ShapeContainer1).TabIndex = 242;
		...
		this.lblCustomerName.Location = new System.Drawing.Point(69, 152);
		this.lblCustomerName.Name = "lblCustomerName";
		this.lblCustomerName.Size = new System.Drawing.Size(151, 30);
		this.lblCustomerName.TabIndex = 246;
		...
		base.ClientSize = new System.Drawing.Size(961, 523);
		...
		base.Name = "frmReportCustomerPayment";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Report Pembayaran Customer";
		((System.ComponentModel.ISupportInitialize)this.dgvList).EndInit();
		base.ResumeLayout(false);
		base.PerformLayout();
	}

	public frmReportCustomerPayment()
	{
		base.KeyDown += frmreportCustomerPayment_KeyDown;
		base.Load += frmreportCustomerPayment_Load;
		InitializeComponent();
		DoubleBuffered = true;
	...
	private void frmreportCustomerPayment_KeyDown(object sender, KeyEventArgs e)
	{
	...
	private void frmreportCustomerPayment_Load(object sender, EventArgs e)
	{
		prepareForm();
		...
		while (true)
		{
			try
			{
				...
				default:
				{
					...
					btnSearch.Focus();
					dataTable = cSalesInvoicePayment.Search(1, dtpBegin.Value, dtpEnd.Value, _customerId, Conversions.ToInteger(cComboItem5.Value), Conversions.ToInteger(cComboItem4.Value), 0, Conversions.ToInteger(cComboItem3.Value), Conversions.ToInteger(cComboItem2.Value), Module1.pubGroupId);
					dgvList.Rows.Clear();
					formatGrid();
				...
				case 1997:
					...
					case 2:
						Cursor = Cursors.Default;
						Module1.SaveError(Information.Err(), "frmReportCustomerPayment", "btnSearch_click", "");
						goto end_IL_0001;
					}
					break;
				}
