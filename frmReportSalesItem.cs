...
[DesignerGenerated]
public class frmReportSalesItem : Form
{
	...
	[field: AccessedThroughProperty("ShapeContainer2")]
	private virtual ShapeContainer ShapeContainer2
	{
		get; [MethodImpl(MethodImplOptions.Synchronized)]
		set;
	}
	...
	private void InitializeComponent()
	{
		...
		this.btnReset.Location = new System.Drawing.Point(153, 381);
		...
		this.dgvList.TabIndex = 163;
		this.btnSearch.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
		this.btnSearch.Location = new System.Drawing.Point(100, 381);
		...
		this.cboGroupBy.Location = new System.Drawing.Point(101, 354);
		this.cboGroupBy.Name = "cboGroupBy";
		this.cboGroupBy.Size = new System.Drawing.Size(120, 21);
		this.cboGroupBy.TabIndex = 12;
		...
		this.lblCustomerName.TabIndex = 180;
		...
		((System.Windows.Forms.Control)(object)this.ShapeContainer1).Size = new System.Drawing.Size(984, 525);
		((System.Windows.Forms.Control)(object)this.ShapeContainer1).TabIndex = 183;
		...
		this.cboItemCategory.Location = new System.Drawing.Point(101, 300);
		...
		this.cboItem.Location = new System.Drawing.Point(101, 327);
		...
		this.chkDO.Checked = true;
		this.chkDO.CheckState = System.Windows.Forms.CheckState.Checked;
		this.chkDO.Location = new System.Drawing.Point(102, 443);
		this.chkDO.Name = "chkDO";
		this.chkDO.Size = new System.Drawing.Size(130, 30);
		this.chkDO.TabIndex = 12;
		this.chkDO.Text = "Termasuk barang dari Pengiriman Pesanan";
		this.chkDO.UseVisualStyleBackColor = true;
		this.chkDO.Visible = false;
		this.Label12.AutoSize = true;
		this.Label12.Location = new System.Drawing.Point(11, 451);
		this.Label12.Name = "Label12";
		this.Label12.Size = new System.Drawing.Size(28, 13);
		this.Label12.TabIndex = 188;
		this.Label12.Text = "Opsi";
		...
		this.cboUseOldPrice.Location = new System.Drawing.Point(101, 273);
		this.cboUseOldPrice.Name = "cboUseOldPrice";
		this.cboUseOldPrice.Size = new System.Drawing.Size(120, 21);
		this.cboUseOldPrice.TabIndex = 9;
		this.Label29.AutoSize = true;
		this.Label29.Location = new System.Drawing.Point(10, 276);
		this.Label29.Name = "Label29";
		this.Label29.Size = new System.Drawing.Size(63, 13);
		this.Label29.TabIndex = 192;
		this.Label29.Text = "Extra Harga";
		((System.Windows.Forms.Control)(object)this.ShapeContainer2).Location = new System.Drawing.Point(0, 0);
		((System.Windows.Forms.Control)(object)this.ShapeContainer2).Margin = new System.Windows.Forms.Padding(0);
		((System.Windows.Forms.Control)(object)this.ShapeContainer2).Name = "ShapeContainer1";
		this.ShapeContainer2.Shapes.AddRange((Shape[])(object)new Shape[2]
		{
			(Shape)this.LineShape1,
			(Shape)this.LineShape2
		});
		((System.Windows.Forms.Control)(object)this.ShapeContainer2).Size = new System.Drawing.Size(984, 562);
		((System.Windows.Forms.Control)(object)this.ShapeContainer2).TabIndex = 90;
		((System.Windows.Forms.Control)(object)this.ShapeContainer2).TabStop = false;
		base.AcceptButton = this.btnSearch;
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(984, 525);
		base.Controls.Add(this.cboUseOldPrice);
		base.Controls.Add(this.Label29);
		base.Controls.Add(this.Label12);
		base.Controls.Add(this.chkDO);
		...
		base.Name = "frmReportSalesItem";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Report Penjualan per Barang";
		((System.ComponentModel.ISupportInitialize)this.dgvList).EndInit();
		base.ResumeLayout(false);
		base.PerformLayout();
	}

	public frmReportSalesItem()
	{
		base.KeyDown += frmReportSalesItem_KeyDown;
		base.Load += frmReportSalesItem_Load;
		InitializeComponent();
		DoubleBuffered = true;
	...
	private void frmReportSalesItem_KeyDown(object sender, KeyEventArgs e)
	{
	...
	private void frmReportSalesItem_Load(object sender, EventArgs e)
	{
		prepareForm();
	...
	private void btnSearchCustomer_Click(object sender, EventArgs e)
	{
		...
		frmCustomerMiniSearch2.CallerName = "ReportSalesItem";
			...
			try
			{
				...
				checked
				{
					...
					default:
					{
						...
						cComboItem cComboItem7 = (cComboItem)cboUseOldPrice.SelectedItem;
						cComboItem cComboItem8 = (cComboItem)cboItemCategory.SelectedItem;
						cComboItem cComboItem9 = (cComboItem)cboItem.SelectedItem;
						...
						{
							Interaction.MsgBox("Pilih extra harga", MsgBoxStyle.Information);
						...
						btnSearch.Focus();
						dataTable = cSalesInvoice.SearchItem(dtpBegin.Value, dtpEnd.Value, _customerId, Conversions.ToInteger(cComboItem5.Value), Conversions.ToInteger(cComboItem6.Value), Conversions.ToInteger(cComboItem7.Value), Conversions.ToInteger(cComboItem8.Value), Conversions.ToInteger(cComboItem9.Value), Conversions.ToInteger(cComboItem4.Value), Conversions.ToInteger(cComboItem3.Value), 0, Conversions.ToInteger(cComboItem2.Value), cboGroupBy.Text, chkDO.Checked, Module1.pubGroupId);
						dgvList.Rows.Clear();
						formatGrid();
						string left = "";
						bool flag = true;
