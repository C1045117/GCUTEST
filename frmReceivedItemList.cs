...
[DesignerGenerated]
public class frmReceivedItemList : Form
{
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(GCUv2.frmReceivedItemList));
		...
		this.lblTitle.Text = "Penerimaan Barang terbaru:";
		this.dgvList.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
		this.dgvList.Location = new System.Drawing.Point(12, 77);
		this.dgvList.Name = "dgvList";
		this.dgvList.Size = new System.Drawing.Size(651, 353);
	...
	public frmReceivedItemList()
	{
		base.KeyDown += frmReceivedItemList_KeyDown;
		InitializeComponent();
		DoubleBuffered = true;
	...
	private void frmReceivedItemList_KeyDown(object sender, KeyEventArgs e)
	{
		...
		while (true)
		{
			try
			{
				...
				default:
				{
					...
					dataTable = cReceivedItem.Search(2, DateAndTime.Now, DateAndTime.Now, 0, 0, Module1.pubGroupId, 0, 0.0, 0, 0, 0);
					FormatGrid();
					IEnumerator enumerator = dataTable.Rows.GetEnumerator();
					while (enumerator.MoveNext())
					{
						DataRow dataRow = (DataRow)enumerator.Current;
						dgvList.Rows.Add(dataRow["riId"], dataRow["riDate"], dataRow["riNumber"], dataRow["supName"], dataRow["storeName"], dataRow["itemName"], Module1.formatCustomDecimal(Conversions.ToString(dataRow["riQty"]), 2));
					}
					if (enumerator is IDisposable)
					{
						(enumerator as IDisposable).Dispose();
					}
					lblTitle.Text = "Penerimaan Barang terbaru (" + Conversions.ToString(DateAndTime.Now) + ")";
					goto end_IL_0001;
				}
				case 344:
					num = -1;
					...
					{
					case 2:
						Module1.SaveError(Information.Err(), "frmReceivedItemList", "GetRecent", "");
						goto end_IL_0001;
					}
					break;
				}
