...
[DesignerGenerated]
public class frmReportSupplierPayment : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.btnWord.Location = new System.Drawing.Point(596, 383);
		...
		this.lblTotal.Location = new System.Drawing.Point(240, 380);
		...
		this.dgvList.Location = new System.Drawing.Point(243, 15);
		...
		this.btnPrint.Location = new System.Drawing.Point(675, 383);
		...
		base.ClientSize = new System.Drawing.Size(762, 411);
		...
		base.Name = "frmReportSupplierPayment";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Report Pembayaran Supplier";
		((System.ComponentModel.ISupportInitialize)this.dgvList).EndInit();
		base.ResumeLayout(false);
		base.PerformLayout();
	}

	public frmReportSupplierPayment()
	{
		...
		while (true)
		{
			try
			{
				...
				default:
				{
					...
					btnSearch.Focus();
					dataTable = cPurchaseInvoiceMultiPayment.Search(1, dtpBegin.Value, dtpEnd.Value, Conversions.ToInteger(cComboItem2.Value), Conversions.ToInteger(cComboItem3.Value), 0, 0, Module1.pubGroupId, 0);
					formatGrid();
					dgvList.Rows.Clear();
				...
				case 1776:
					...
					{
					case 2:
						Module1.SaveError(Information.Err(), "frmReportSupplierPayment", "btnSearch_click", "");
						goto end_IL_0001;
					}
					break;
				}
